...
mixin _$Activity {
 ...
 String get id; String get title; String get subtitle; DateTime get timestamp; String get type;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,subtitle,timestamp,type);

@override
String toString() {
  return 'Activity(id: $id, title: $title, subtitle: $subtitle, timestamp: $timestamp, type: $type)';
}
...
@useResult
$Res call({
 String id, String title, String subtitle, DateTime timestamp, String type
});
...
/// Create a copy of Activity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? subtitle = null,Object? timestamp = null,Object? type = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String subtitle,  DateTime timestamp,  String type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Activity() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.timestamp,_that.type);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String subtitle,  DateTime timestamp,  String type)  $default,) {final _that = this;
switch (_that) {
case _Activity():
return $default(_that.id,_that.title,_that.subtitle,_that.timestamp,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String subtitle,  DateTime timestamp,  String type)?  $default,) {final _that = this;
switch (_that) {
case _Activity() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.timestamp,_that.type);case _:
  return null;
...
class _Activity implements Activity {
  const _Activity({required this.id, required this.title, required this.subtitle, required this.timestamp, required this.type});
...
/// Create a copy of Activity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? subtitle = null,Object? timestamp = null,Object? type = null,}) {
